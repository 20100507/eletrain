				...
				$('#my-confirm1').modal({
					...
					onConfirm : function(options) {
						...
						$.ajax({
							type : "post",
							traditional : true,
							url : "/classes/delClassesByIdsByClassesTeacher?menuId=19",
							data : {
			...
			$('#my-confirm2').modal({
				...
				onConfirm : function(options) {
					$.ajax({
						type : "post",
						traditional : true,
						url : "/classes/deleteClassesByClassesTeacher?menuId=19",
						data : {
							"classesId" : id
						},
						success : function(data) {
	...
	function insertOrDelete(a) {
		$('#my-confirm3').modal({
			...
			onConfirm : function(options) {
				$.ajax({
					type : "post",
					url : "/classes/insertOrDeleteUIByClassesTeacher?menuId=19",
					data : {
						"classesId" : a
					},
					success : function(data) {
                ...
                <div class="tpl-block">
                	<div class="am-g">
						...
						<form method="post" id="searchAddition"
							action="${pageContext.request.contextPath }/classes/getClassesByClassesTeacherId?menuId=19">
						...
						<div class="am-u-sm-12 am-u-md-3">
							<form method="post"
								action="${pageContext.request.contextPath }/classes/searchClassesClassesTeacher?menuId=19">
								<div class="am-u-sm-12 am-u-md-3">
									<div class="am-form-group">
                            ...
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
									<%-- <button type="button"
										...
										onclick="location='${pageContext.request.contextPath}/classes/addClassesUIByClassesTeacher?menuId=19'">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:80px" class="table-type">班级状态</th>
                                                 ...
                                                 <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
														<%-- <button id="ed" type="button"
															...
															onclick="location='${pageContext.request.contextPath }/classes/updateClassesUIByClassesTeacher?classesId=${classes.classesId }&menuId=19&type=0'">
														...
														<button id="del" type="button"
																		...
																		<div class="am-modal-actions-group">
																			<ul class="am-list">
																				<li class="am-modal-actions-header"><a
																					href="${pageContext.request.contextPath }/classes/insertOrDeleteUIByClassesTeacher?classesId=${classes.classesId }&menuId=19&type=0">添加学生</a>
																				</li>
																				<li class="am-modal-actions-header"><a
																					href="${pageContext.request.contextPath }/classes/insertOrDeleteUIByClassesTeacher?classesId=${classes.classesId }&menuId=19&type=1">删除学生</a>
																				</li>
																			</ul>
																		</div>
																	</div>
															...
															<button id="infoBut" type="button"
																onclick="location='${pageContext.request.contextPath }/classes/lookInfo?classesId=${classes.classesId }&type=0&menuId=19'"
																class="am-btn am-btn-default am-btn-xs am-hide-sm-only">
																<span class="am-icon-copy"> </span>查看详情
															</button>
															<div class="am-modal am-modal-confirm" tabindex="-1"
															id="my-confirm2">
															<div class="am-modal-dialog">
                               ...
                               <div class="am-cf">
                                    ...
                                    <div class="am-fr">
                                        ...
                                        <c:if test="${pageBean.page ne 1}">
                                            <li><a href="${pageContext.request.contextPath }/classes/${path }&page=1&menuId=19">首页</a></li>
                                            <li><a href="${pageContext.request.contextPath }/classes/${path }&page=${pageBean.page -1}&menuId=19">«</a></li>
                                        </c:if>
                                        <c:choose>
                                        ...
                                        <c:forEach var="i" begin="${begin }" end="${end }">
											...
											<c:if test="${pageBean.page !=  i }">
												<li><a href="${ pageContext.request.contextPath }/classes/${path }&page=${i}&menuId=19">${i }</a></li>
											</c:if>
										</c:forEach>
										<c:if test="${pageBean.page ne pageBean.totalPage  }">
										<li><a href="${ pageContext.request.contextPath }/classes/${path }&page=${pageBean.page +1}&menuId=19">»</a></li>
										<li><a href="${ pageContext.request.contextPath }/classes/${path }&page=${pageBean.totalPage}&menuId=19">尾页</a></li>
										</c:if>
										</ul>
                                    </div>
                                </div>
