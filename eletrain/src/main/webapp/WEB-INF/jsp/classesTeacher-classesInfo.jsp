                        ...
                        <!-- <div class="am-u-sm-12 am-u-md-9"> -->
							<div class="am-panel-group" id="accordion">
								  ...
								  <div class="am-panel am-panel-default">
								    ...
								    <div id="do-not-say-1" class="am-panel-collapse am-collapse am-in">
										<div class="am-panel-bd">
											...
											<div>
												<span>班级状态:</span><span>&nbsp;&nbsp;&nbsp;&nbsp;</span><span><c:if test="${classes.capacity==0 }">正常</c:if><c:if test="${classes.capacity==1 }">已结课</c:if></span>
											</div>
											<div>
								  ...
								  <div class="am-panel am-panel-default">
								    ...
								    <div id="do-not-say-5" class="am-panel-collapse am-collapse am-collapse">
										<div class="am-panel-bd">
											<table border="1">
								    ...
								    <div id="do-not-say-2" class="am-panel-collapse am-collapse">
								      <div class="am-panel-bd">
											<table border="1">
												<thead>
													<tr>
														<th style="width: 100px; text-align: center; vertical-align: middle">姓名</th>
														<th style="width: 50px; text-align: center; vertical-align: middle">性别</th>
														<th style="width: 50px; text-align: center; vertical-align: middle">职称</th>
														<th style="width: 50px; text-align: center; vertical-align: middle">教师类别</th>
														<th style="width: 100px; text-align: center; vertical-align: middle">电话</th>
														<th style="width: 350px; text-align: center; vertical-align: middle">工作单位</th>
														<th style="width: 100px; text-align: center; vertical-align: middle">学历</th>
														<th style="width: 200px; text-align: center; vertical-align: middle">身份证号</th>
													</tr>
												</thead>
												<tbody>
													<c:forEach items="${teacherList }" var="teacher">
														<tr>
															<td style="width: 100px; text-align: center; vertical-align: middle">${teacher.username }(${teacher.loginname })</td>
															<td style="width: 50px; text-align: center; vertical-align: middle">
															<c:if
																test="${teacher.email==0 }">女</c:if>
															<c:if test="${teacher.email==1 }">男</c:if></td>
															<td style="width: 50px; text-align: center; vertical-align: middle">${teacher.position }</td>
															<td style="width: 50px; text-align: center; vertical-align: middle"><c:if test="${teacher.identify==2 }">授课教师</c:if><c:if test="${teacher.identify==6 }">班主任</c:if></td>
															<td style="width: 100px; text-align: center; vertical-align: middle">${teacher.telephone }</td>
															<td style="width: 350px; text-align: center; vertical-align: middle">${teacher.address }</td>
															<td style="width: 100px; text-align: center; vertical-align: middle">${teacher.education }</td>
															<td style="width: 200px; text-align: center; vertical-align: middle">${teacher.idcard }</td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
											...
											<table border="1">
												<thead>
													<tr>
														...
														<th style="width: 50px; text-align: center; vertical-align: middle">性别</th>
														<th style="width: 100px; text-align: center; vertical-align: middle">电话</th>
														<th style="width: 400px; text-align: center; vertical-align: middle">工作单位</th>
														<th style="width: 100px; text-align: center; vertical-align: middle">学历</th>
														<th style="width: 100px; text-align: center; vertical-align: middle">身份证号</th>
													</tr>
												</thead>
												<c:forEach items="${studentList }" var="stu">
													<tbody>
														<tr>
															<td style="width: 100px; text-align: center; vertical-align: middle">${stu.username }(${stu.loginname })</td>
															<td style="width: 50px; text-align: center; vertical-align: middle">${stu.email }</td>
															<td style="width: 100px; text-align: center; vertical-align: middle">${stu.telephone }</td>
															<td style="width: 400px; text-align: center; vertical-align: middle">${stu.address }</td>
															<td style="width: 100px; text-align: center; vertical-align: middle">${stu.education }</td>
															<td style="width: 100px; text-align: center; vertical-align: middle">${stu.idcard }</td>
														</tr>
													</tbody>
												</c:forEach>
											</table>
