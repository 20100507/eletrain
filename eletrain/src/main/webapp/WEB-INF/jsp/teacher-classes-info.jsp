								  ...
								  <div class="am-panel am-panel-default">
								    ...
								    <div id="do-not-say-1" class="am-panel-collapse am-collapse am-in">
										<div class="am-panel-bd">
											...
											<div>
												<span>班级创建时间:</span><span>&nbsp;&nbsp;&nbsp;&nbsp;</span><span>${classes.createtime }</span>
											</div>
											<div>
												<span>班级开始时间:</span><span>&nbsp;&nbsp;&nbsp;&nbsp;</span><span>${classes.starttime }</span>
											</div>
										</div>
									</div>
								  </div>
										...
										<div class="am-panel-bd">
											<table border="1">
												...
												<tbody>
													<tr height="50px">
														<td
															style="width: 100px; text-align: center; vertical-align: middle">日期</td>
														<td
															style="width: 100px; text-align: center; vertical-align: middle">授课时间</td>
														<td
															style="width: 300px; text-align: center; vertical-align: middle">授课内容</td>
														<td
															style="width: 100px; text-align: center; vertical-align: middle">学时</td>
														<td
															style="width: 100px; text-align: center; vertical-align: middle">地点</td>
														<td
															style="width: 100px; text-align: center; vertical-align: middle">授课教师</td>
														<td
															style="width: 100px; text-align: center; vertical-align: middle">备注</td>
													</tr>
