            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code">新建学员成绩(管理员)</span>
                    </div>
                </div>
                <div class="tpl-block ">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" data-am-validator id="addScoreForm" action="${pageContext.request.contextPath}/score/addScore" method="post">
                            	...
                            	<!-- <div class="am-form-group">
                                   <label for="teacher-select" class="am-u-sm-3 am-form-label">老师</label> 
									<div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-form-inline">
                                        <input type="number" id="theoryscore" name="theoryscore" class="am-form-field am-radius" onkeyup="this.value=this.value.replace(/\s+/g,'')"
