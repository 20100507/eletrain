				...
				<div class="tpl-block">
					...
					<div class="am-g">
						<div class="am-u-sm-12">
							<form id="insertOrDelete" method="post" class="am-form" action="${pageContext.request.contextPath }/classes/insertOrDeleteByClassesTeacher?menuId=19">
									...
									<div class="am-fr">
										<ul class="am-pagination tpl-pagination">
											<c:if test="${pageBean.page ne 1}">
												<li><a
													href="${pageContext.request.contextPath }/classes/insertOrDeleteUIByClassesTeacher?page=1&classesId=${classesId}&type=${type }">首页</a></li>
												<li><a
													href="${pageContext.request.contextPath }/classes/insertOrDeleteUIByClassesTeacher?page=${pageBean.page -1}&classesId=${classesId}&type=${type }">«</a></li>
											</c:if>
											<c:choose>
											...
											<c:forEach var="i" begin="${begin }" end="${end }">
												...
												<c:if test="${pageBean.page !=  i }">
													<li><a
														href="${ pageContext.request.contextPath }/classes/insertOrDeleteUIByClassesTeacher?page=${i}&classesId=${classesId}&type=${type }">${i }</a></li>
												</c:if>
											</c:forEach>
											<c:if test="${pageBean.page < pageBean.totalPage  }">
												<li><a
													href="${ pageContext.request.contextPath }/classes/insertOrDeleteUIByClassesTeacher?page=${pageBean.page +1}&classesId=${classesId}&type=${type }">»</a></li>
												<li><a
													href="${ pageContext.request.contextPath }/classes/insertOrDeleteUIByClassesTeacher?page=${pageBean.totalPage}&classesId=${classesId}&type=${type }">尾页</a></li>
											</c:if>
										</ul>
									</div>
								</div>
