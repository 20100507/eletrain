			...
			$('#my-confirm1').modal({
				...
				onConfirm : function(options) {
					...
					$.ajax({
						type : "post",
						traditional : true,
						url : "/syllabus/deleteSyllabusByIdsByClassesTeacher?menuId=52",
						data : {
        ...
        <div class="tpl-content-wrapper">
            <div class="tpl-portlet-components">
                ...
                <div class="tpl-block">
                            ...
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
									<%-- <button type="button"
										...
										onclick="location='${pageContext.request.contextPath}/syllabus/addSyllabusUIByClassesTeacher?menuId=52'">
												...
												<div class="am-modal-actions-group">
													<ul class="am-list">
														<li class="am-modal-actions-header"><a
															href="${pageContext.request.contextPath }/syllabus/exportSyllabusByClassesTeacher?mould=1">课表安排表.xlsx</a>
														</li>
														<li class="am-modal-actions-header"><a
															href="${pageContext.request.contextPath }/syllabus/exportSyllabusByClassesTeacher?mould=2">课表安排表.xls</a>
														</li>
													</ul>
												</div>
											</div>
					...
					<form method="post"
						action="${pageContext.request.contextPath }/syllabus/getClassesSyllabusByTeacher?menuId=52">
						<div class="am-u-sm-12 am-u-md-3">
							<div class="am-form-group">
								...
								<script type="text/javascript">
									function search(){
										if($('#sear').val()==3){
											window.location='${pageContext.request.contextPath }/syllabus/getClassesSyllabusByTeacher?menuId=52';
										}
									}
								</script>
							</div>
                                                 ...
                                                 <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
														<%-- <button id="ed" type="button"
															...
															onclick="location='${pageContext.request.contextPath }/syllabus/updateSyllabusUIByClassesTeacher?syllabusId=${cdv.syllabusId }&menuId=52'">
                                ...
                                <div class="am-cf">
                                    <div class="am-fr">
                                        ...
                                        <c:if test="${pageBean.page ne 1}">
                                            <li><a href="${pageContext.request.contextPath }/syllabus/${path }&page=1&menuId=52">首页</a></li>
                                            <li><a href="${pageContext.request.contextPath }/syllabus/${path }&page=${pageBean.page -1}&menuId=52">«</a></li>
                                        </c:if>
                                        <c:choose>
                                        ...
                                        <c:forEach var="i" begin="${begin }" end="${end }">
											...
											<c:if test="${pageBean.page !=  i }">
												<li><a href="${ pageContext.request.contextPath }/syllabus/${path }&page=${i}&menuId=52">${i }</a></li>
											</c:if>
										</c:forEach>
										<c:if test="${pageBean.page ne pageBean.totalPage  }">
										<li><a href="${ pageContext.request.contextPath }/syllabus/${path }&page=${pageBean.page +1}&menuId=52">»</a></li>
										<li><a href="${ pageContext.request.contextPath }/syllabus/${path }&page=${pageBean.totalPage}&menuId=52">尾页</a></li>
										</c:if>
										</ul>
                                    </div>
                                </div>
