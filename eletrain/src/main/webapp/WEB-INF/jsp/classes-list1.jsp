		...
		$('#doc-confirm-toggle').on('click', function() {
			$('#my-confirm1').modal({
				...
				onConfirm : function(options) {
					...
					if (classesIds == "") {
						alert("对不起，您还没有选择要恢复的选项！");
						return;
					}
					$.ajax({
						type : "post",
						traditional : true,
						url : "/classes/updClassesByIds?menuId=17",
						data : {
	...
	function insertOrDelete(a) {
		$('#my-confirm3').modal({
			...
			onConfirm : function(options) {
				$.ajax({
					type : "post",
					url : "/classes/insertOrDeleteUI?menuId=17",
					data : {
						"classesId" : a
					},
					success : function(data) {
                ...
                <div class="tpl-block">
                    <div class="am-g">
                            ...
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
									...
									<button type="button" id="doc-confirm-toggle"
										...
										<span class="am-icon-trash-o"></span> 批量恢复
									</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="am-modal am-modal-confirm" tabindex="-1"
							id="my-confirm1">
							<div class="am-modal-dialog">
								<div class="am-modal-hd">批量恢复</div>
								<div class="am-modal-bd">正在操作的是恢复这些班级的信息，确定要继续吗？</div>
						...
						<div class="am-u-sm-12 am-u-md-3">
							...
							<%-- 
                        <form action="${pageContext.request.contextPath }/teacher/searchTeracher">
                              <div class="am-input-group am-input-group-sm">
                                <input name="index" type="text" class="am-form-field">
                                <span class="am-input-group-btn">
                                        ...
                                        <tr>
                                            ...
                                            <td class="am-hide-sm-only">${classes.starttime }</td>
                                             <td>
                                                 <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
														<button disabled id="ed" type="button"
															class="am-btn am-btn-default am-btn-xs am-text-secondary"
															onclick="location='${pageContext.request.contextPath }/classes/updateClassesUI?classesId=${classes.classesId }&menuId=17&type=1'">
														...
														<button disabled id="infoBut" type="button"
															...
															<div class="am-modal-dialog">
																...
																<div class="am-modal-bd">
																	<div class="am-modal-actions-group">
																		<ul class="am-list">
																			<li class="am-modal-actions-header"><a
																				href="${pageContext.request.contextPath }/classes/insertOrDeleteUI?classesId=${classes.classesId }&menuId=17&adType=0&type=1">添加学生</a>
																			</li>
																			<li class="am-modal-actions-header"><a
																				href="${pageContext.request.contextPath }/classes/insertOrDeleteUI?classesId=${classes.classesId }&menuId=17&adType=1&type=1">删除学生</a>
																			</li>
																		</ul>
																	</div>
																</div>
														...
														<button id="infoBut" type="button"
															onclick="location='${pageContext.request.contextPath }/classes/lookInfo?classesId=${classes.classesId }&menuId=17&type=0'"
															class="am-btn am-btn-default am-btn-xs am-hide-sm-only">
                                ...
                                <div class="am-cf">
                                    ...
                                    <div class="am-fr">
                                        ...
                                        <c:if test="${pageBean.page ne 1}">
                                            <li><a href="${pageContext.request.contextPath }/classes/list?page=1&type=1&menuId=17">首页</a></li>
                                            <li><a href="${pageContext.request.contextPath }/classes/list?page=${pageBean.page -1}&type=1&menuId=17">«</a></li>
                                        </c:if>
                                        <c:choose>
                                        ...
                                        <c:forEach var="i" begin="${begin }" end="${end }">
											...
											<c:if test="${pageBean.page !=  i }">
												<li><a href="${ pageContext.request.contextPath }/classes/list?page=${i}&type=1&menuId=17">${i }</a></li>
											</c:if>
										</c:forEach>
										<c:if test="${pageBean.page ne pageBean.totalPage  }">
										<li><a href="${ pageContext.request.contextPath }/classes/list?page=${pageBean.page +1}&type=1&menuId=17">»</a></li>
										<li><a href="${ pageContext.request.contextPath }/classes/list?page=${pageBean.totalPage}&type=1&menuId=17">尾页</a></li>
										</c:if>
										</ul>
                                    </div>
                                </div>
