  ...
  <%--   <script src="${pageContext.request.contextPath}/assets/js/app.js"></script> --%>
    ...
    $(function(){
    	$("#addNotice").click(function(){
        	$("#confirmBox1").html("新建公告");
    		$("#confirmBox2").html("确定要新建此公告吗？？？？");
        	$('#my-confirm').modal({
            	relatedTarget: this,
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code">新建公告</span>
                    </div>
                </div>
                <div class="tpl-block ">
                    <div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" data-am-validator id="addNoticeForm" action="${pageContext.request.contextPath}/notice/addNotice" method="post">
                            	<input type="hidden" name="menuId" value="${menuId}"/>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">标题</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="title" name="title" required  onkeydown="return banInputSapce(event);" 
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                    	<textarea name="content" id="myEditor" style="width:730px;height:500px"></textarea>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <button type="button" id="addNotice" class="am-btn am-btn-primary">新建</button>
