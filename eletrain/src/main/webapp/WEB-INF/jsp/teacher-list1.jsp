			...
			<div class="tpl-portlet-components">
				<div class="portlet-title">
					<div class="caption font-green bold">
						<span class="am-icon-code"></span> 离职教师列表：
					</div>
				</div>
				<div class="tpl-block">
					<div class="am-g">
						...
						<div class="am-modal am-modal-confirm" tabindex="-1"
							...
							<div class="am-modal-dialog">
								...
								<div class="am-modal-bd">正在操作的是恢复这些教师的信息，确定要继续吗？</div>
													...
													<div class="am-btn-toolbar">
														<div class="am-btn-group am-btn-group-xs">
															<button disabled id="ed" type="button"
																...
																onclick="location='${pageContext.request.contextPath }/teacher/updateTeacherUI?teacherId=${teacher.teacherId }&menuId=0&type=1'">
															...
															<button disabled id="initPwd" type="button"
									...
									<div class="am-fr">
										<ul class="am-pagination tpl-pagination">
											<c:if test="${pageBean.page ne 1}">
												<li><a
													href="${pageContext.request.contextPath }/teacher/list?page=1&type=1&menuId=0">首页</a></li>
												<li><a
													href="${pageContext.request.contextPath }/teacher/list?page=${pageBean.page -1}&type=1&menuId=0">«</a></li>
											</c:if>
											<c:choose>
											...
											<c:forEach var="i" begin="${begin }" end="${end }">
												...
												<c:if test="${pageBean.page !=  i }">
													<li><a
														href="${ pageContext.request.contextPath }/teacher/list?page=${i}&type=1&menuId=0">${i }</a></li>
												</c:if>
											</c:forEach>
											<c:if test="${pageBean.page ne pageBean.totalPage  }">
												<li><a
													href="${ pageContext.request.contextPath }/teacher/list?page=${pageBean.page +1}&type=1&menuId=0">»</a></li>
												<li><a
													href="${ pageContext.request.contextPath }/teacher/list?page=${pageBean.totalPage}&type=1&menuId=0">尾页</a></li>
											</c:if>
											</ul>
									</div>
								</div>
